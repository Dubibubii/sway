...
export function SpreadExplainerSheet({ open, onClose, buyPrice, sellPrice, direction = 'YES' }: SpreadExplainerSheetProps) {
  // Use example prices if not provided (educational mode)
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-50 max-h-[85vh] bg-zinc-900 rounded-t-3xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 space-y-5">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold">Why Estimates Vary</h2>
                <button onClick={onClose} className="p-2 rounded-full hover:bg-white/10" data-testid="button-close-spread">
                  <X size={20} />
                </button>
              </div>
